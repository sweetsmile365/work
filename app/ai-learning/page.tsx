...
const aiDailyLessons: AiDailyLesson[] = [
  { day: 1, title: "What Is AI?", focus: "AIとは何？何がAIではない？ / 什么是AI？什么不是AI？ / What is AI, and what is not AI?", activity: "家やスマホの中からAIの例を3つ見つけよう。 / 从家里或手机中找出3个AI例子。 / Find 3 examples of AI at home or on your phone." },
  { day: 2, title: "Five Big Ideas of AI", focus: "認識・推論・学習・対話・影響 / 感知・推理・学习・互动・影响 / Perceive, Reason, Learn, Interact, Impact", activity: "昨日見つけたAIを5つの考え方に分類しよう。 / 把昨天找到的AI例子分到5个类别中。 / Sort yesterday’s AI examples into the five big ideas." },
  { day: 3, title: "Can Machines Learn?", focus: "機械は人間のように理解するのではなく、データからパターンを見つける。 / 机器并不像人一样真正理解，而是从数据中寻找规律。 / Machines find patterns in data rather than understanding like humans.", activity: "猫と犬を見分けるAIには、どんなデータが必要？ / AI要分辨猫和狗，需要什么样的数据？ / What data would an AI need to tell cats from dogs?" },
  { day: 4, title: "Data & Prediction", focus: "学習データ・予測・間違い / 训练数据・预测・错误 / Training data, prediction, and mistakes", activity: "学習データが偏る例を3つ考えよう。 / 想出3个可能让训练数据产生偏差的例子。 / Think of 3 examples that could make training data unfair." },
  { day: 5, title: "What Is an Algorithm?", focus: "アルゴリズムは、はっきりした実行可能な手順。 / 算法是一组清晰、可执行的步骤。 / An algorithm is a clear set of executable steps.", activity: "「サンドイッチを作る」5ステップのアルゴリズムを書こう。 / 写一个“做三明治”的5步算法。 / Write a 5-step algorithm for making a sandwich." },
  { day: 6, title: "Debug an Algorithm", focus: "手順の問題を見つけて直す。 / 找出步骤中的问题并修正。 / Find problems in the steps and fix them.", activity: "前回のアルゴリズムから1ステップ抜いて、何が起きるか考えよう。 / 从上一次的算法里删掉一步，想想会发生什么。 / Remove one step from the last algorithm and predict what happens." },
  { day: 7, title: "How Machines Learn", focus: "入力 → 学習 → モデル → 予測 / 输入 → 训练 → 模型 → 预测 / Input → Training → Model → Prediction", activity: "「Training」と「Testing」の違いを自分の言葉で説明しよう。 / 用自己的话解释Training和Testing的区别。 / Explain the difference between training and testing in your own words." },
  { day: 8, title: "Supervised Learning", focus: "ラベル付きデータが機械学習を助ける。 / 带标签的数据可以帮助机器学习。 / Labeled data helps machines learn.", activity: "画像を2種類に分け、それぞれ5個以上の学習例を考えよう。 / 设计2类图片，每类至少列出5个训练样本。 / Create 2 image classes and list at least 5 training examples for each." },
  { day: 9, title: "Why AI Makes Mistakes", focus: "データ不足・偏り・環境の変化はAIの間違いにつながる。 / 数据不足、偏差和环境变化都会导致AI出错。 / Limited data, bias, and changing conditions can cause AI errors.", activity: "AIが間違えそうな現実の場面を2つ考えよう。 / 想出2个AI可能判断错误的真实场景。 / Give 2 real-life situations where AI might make a mistake." },
  { day: 10, title: "Bias & Fairness", focus: "AIの偏りは、データや人の選択から生まれることがある。 / AI的偏差往往来自数据和人的选择。 / AI bias can come from data and human choices.", activity: "「公平なAI」とは何か、2文で書こう。 / 用2句话写出你理解的“公平AI”。 / Write 2 sentences about what “fair AI” means." },
  { day: 11, title: "Generative AI", focus: "生成AIは、学んだパターンを使って新しい内容を作る。 / 生成式AI会利用学到的模式生成新内容。 / Generative AI creates new content from learned patterns.", activity: "「答えを検索する」と「答えを生成する」の違いを比べよう。 / 比较“搜索答案”和“生成答案”有什么不同。 / Compare searching for an answer with generating an answer." },
  { day: 12, title: "AI Smart User", focus: "事実確認・プライバシー保護・最後は自分で判断。 / 核对事实、保护隐私，最后由自己做判断。 / Fact-check, protect privacy, and make the final judgment yourself.", activity: "自分の「AIを使う3つのルール」を書こう。 / 写下自己的3条AI使用规则。 / Write your own 3 rules for using AI." }
];
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-0.5 truncate text-xs text-slate-300">
              {lesson.title} · 無料 · AI初心者 · 毎日20分 / 免费 · AI零基础 · 每天20分钟 / Free · Beginner · 20 min/day
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start justify-between gap-4 border-b border-white/10 px-4 py-3 sm:px-6">
              <div>
                ...
                <div className="mt-1 text-xs text-slate-300">
                  MIT Day of AI · Middle Grades · PWA内で学習 / 在PWA内学习 / Learn inside the PWA
                </div>
              </div>
              <button
                type="button"
                ...
                <div className="space-y-3">
                  ...
                  <div className="rounded-2xl border border-emerald-200/15 bg-emerald-300/[0.08] p-4">
                    ...
                    <div className="mt-2 text-sm leading-relaxed text-slate-200">
                      答えを見ずに、今日学んだことを自分の言葉で説明しよう。家族に説明できたら完了。 / 不看答案，用自己的话说明今天学到的内容。能给家人讲清楚，就算完成。 / Without looking at the answer, explain what you learned today in your own words. If you can explain it clearly to your family, you’re done.
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    ...
                    >
                      {lessonIndex === aiDailyLessons.length - 1 ? "完了 / 已完成 / DONE ✓" : "今日を完了 / 完成今天 / COMPLETE TODAY →"}
                    </button>
                  </div>
